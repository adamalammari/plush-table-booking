    ...
    <footer id="contact" className="py-16 px-6 bg-secondary border-t border-primary/10">
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <div className="space-y-2 text-sm text-champagne/60">
        ...
        <div>
          ...
          <div className="space-y-3 text-sm text-champagne/60">
      ...
      <div className="max-w-6xl mx-auto mt-12 pt-8 border-t border-primary/10 text-center text-xs text-champagne/40">
